...
export const formSections: FormSection[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        conditionalOtherLabel: "¿Qué otra marca?",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        conditionalOtherLabel: "¿Qué otra nota de entrega?",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: "repeated_tasks",
        label: "¿Qué tareas repites constantemente?",
        type: "multiple-choice",
        options: [
      ...
      {
        id: "stress_source",
        label: "¿Qué te genera más estrés?",
        type: "multiple-choice",
        options: [
          "Mensajes acumulados",
          "Olvidar pedidos",
      ...
      {
        id: "lost_info",
        label: "¿Qué información se te suele perder?",
        type: "multiple-choice",
        options: [
          "Pedidos",
          "Datos de clientes",
      ...
      },
      {
        ...
        label: "¿Qué te gustaría mejorar primero?",
        type: "multiple-choice",
        options: [
          "Organización",
          "Ventas",
