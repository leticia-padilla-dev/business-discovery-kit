...
export const formSections: FormSection[] = [
  {
    ...
    questions: [
      { id: "businessName", label: "Nombre del negocio", type: "text", required: true, placeholder: "Mi negocio" },
      { id: "contactName", label: "Persona responsable", type: "text", required: true, placeholder: "Tu nombre" },
      { id: "phone", label: "Teléfono", type: "phone", required: true, placeholder: "+34 600 000 000" },
      { id: "whatsapp", label: "WhatsApp", type: "phone", placeholder: "+34 600 000 000", helpText: "Si es distinto al teléfono." },
      { id: "email", label: "Email", type: "email", required: true, placeholder: "tucorreo@email.com" },
      { id: "city", label: "Ciudad o zona donde trabajas", type: "text", placeholder: "Madrid, zona norte..." },
      { id: "social", label: "Redes sociales o web actual", type: "url", placeholder: "https://instagram.com/...", helpText: "Pega un enlace si tienes." },
    ],
  },
  {
    id: "products",
    ...
    questions: [
      ...
      { id: "product_count", label: "¿Cuántos productos gestionas aproximadamente?", type: "number", min: 0 },
      {
        id: "price_changes",
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "active_clients", label: "¿Cuántos clientes activos tienes aproximadamente?", type: "number", min: 0 },
      {
      ...
      { id: "client_notes", label: "Cuéntame cualquier detalle importante sobre tus clientes", type: "textarea" },
    ],
  },
  {
    id: "orders",
    ...
    questions: [
      {
        ...
        type: "multiple-choice",
        options: ["WhatsApp", "Llamadas", "Instagram", "Facebook", "En persona", "Email", "Formulario"],
      },
      { id: "order_organization", label: "¿Cómo organizas actualmente los pedidos?", type: "textarea" },
      { id: "order_problems", label: "¿Qué problemas tienes hoy con los pedidos?", type: "textarea" },
      {
        id: "pending_payments",
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "shared_links_type", label: "¿Qué tipo de direcciones o enlaces compartes?", type: "textarea" },
      {
  ...
  },
  {
    ...
    emphasis: true,
    questions: [
      { id: "time_loss", label: "¿Qué parte de tu trabajo te hace perder más tiempo?", type: "textarea" },
      ...
      { id: "stop_manual", label: "¿Qué te gustaría dejar de hacer manualmente?", type: "textarea" },
    ],
  },
  {
    id: "priorities",
